...
#define MPU9250_FIFO_MODE_MASK          0x40 //when the fifo is full, additional writes will not be written to fifo
#define MPU9250_EXT_SYNC_SET_MASK       0x38 //MASK TO ACTIVATE EXTERNAL SYNC
#define MPU9250_DLPF_41_BAND            0x03 
#define MPU9250_DLPF_20_BAND            0x04 
#define MPU9250_DLPF_10_BAND            0x05 
#define MPU9250_DLPF_5_BAND             0x06 
...
#define MPU9250_GYRO_FS_RANGE_250        0x00
#define MPU9250_GYRO_FS_RANGE_500        0x08
#define MPU9250_GYRO_FS_RANGE_1000       0x10
#define MPU9250_GYRO_FS_RANGE_2000       0x18

#define MPU9250_GYRO_FC_DLPF_OFF         0x03
...
#define MPU9250_ACCEL_FS_RANGE_250        0x00
#define MPU9250_ACCEL_FS_RANGE_500        0x08
#define MPU9250_ACCEL_FS_RANGE_1000       0x10
#define MPU9250_ACCEL_FS_RANGE_2000       0x18


//ACCEL_CONFIG_2 register masks
#define MPU9250_ACCEL_FC_DLPF_OFF      0x08
#define MPU9250_A_DLPF_BAND_184        0x01
#define MPU9250_A_DLPF_BAND_92         0x02
#define MPU9250_A_DLPF_BAND_41         0x03
#define MPU9250_A_DLPF_BAND_20         0x04
#define MPU9250_A_DLPF_BAND_10         0x05
#define MPU9250_A_DLPF_BAND_5          0x06
#define MPU9250_A_DLPF_BAND_460        0x07
...
#define MPU9250_H_RESET_MASK            0x80   //BIT WILL AUTO CLEARE, RESET REGS AND RESTOR DEFAULT
#define MPU9250_SLEEP_MASK              0x40   //
#define MPU9250_CYCLE_MASK              0x20   //SWITCH BETWEEN SLEEP AND SINGLE SAMPLE with LP_ACCEL_ODR rate
#define MPU9250_GYRO_STANDBY_CYCLE_MASK 0x10
#define MPU9250_PD_PTAT_MASK            0x08
#define MPU9250_CLKSEL_RESET            0x07   //STOP THE CLOCK AND KEEPS TIMIGN GENERATOR RESEt
#define MPU9250_CLKSEL_INTER            0x00   //INTERNAL 20MHZ OSCILLATOR
#define MPU9250_CLKSEL_PLL              0x01   //AUTO SELECTS BEST CLOCK SOURCE - PLL IF READY

//PWR_MGMT_2 register masks - 0 is on
#define MPU9250_DISABLE_XA_MASK         0x20 //00100000
#define MPU9250_DISABLE_YA_MASK         0x10 //00010000
#define MPU9250_DISABLE_ZA_MASK         0x08 //00001000
#define MPU9250_DISABLE_XG_MASK         0x04 //00000100
#define MPU9250_DISABLE_YG_MASK         0x02 //00000010
#define MPU9250_DISABLE_ZG_MASK         0x01 //00000001
